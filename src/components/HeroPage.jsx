    ...
    return (
        <section className="relative bg-gradient-to-b from-gray-50 to-gray-100 min-h-screen flex flex-col items-center justify-start md:justify-center overflow-hidden">
            ...
            <div className="relative text-center px-6 mt-16 md:mt-0">
                <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-gray-800 leading-snug">
                    Empower Your Future
                    <span
                        className="ml-2 text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-pink-500"
                    >
                        with Skills
                    </span>
                </h1>
            ...
            <div className="w-full px-6 mt-12 md:mt-20">
                <h2 className="text-center text-xl sm:text-2xl md:text-3xl font-semibold text-gray-700 mb-6">
